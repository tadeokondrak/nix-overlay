{ stdenv, lib, fetchFromGitHub, vapoursynth-plugins, python3Packages, tesseract3, python3, makeWrapper, vapoursynth, ffms }:
...
stdenv.mkDerivation rec {
  ...
  installPhase = ''
    ...
    sed -i '1i#!${python3.withPackages (ps: with ps; [ colorama ConfigArgParse pyenchant numpy opencv3 tqdm ])}/bin/python' $out/bin/pythocr
